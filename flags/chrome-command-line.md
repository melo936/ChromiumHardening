...
* PrefersContrast
* SharedWorker
	* We benefit from disabling SharedWorker - reduces leakage (when extensions modify WebAPIs), - because it isn't available on Android, which means most websites will still work without SharedWorker.
* GravitySensor	
